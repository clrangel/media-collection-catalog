...
public record K7RequestDTO(

        @Schema(description = "Título do K7", example = "Viva Emptiness")
        String titulo,
        ...
        @Schema(description = "Descrição do K7", example = "Viva Emptiness é o sexto álbum de estúdio da banda.")
        String descricao,
        ...
        @Schema(
                description = "Lista de faixas do K7 (uma por linha ou numeradas)",
                example = "1. Intro\n2. Track One\n3. Track Two"
        )
        String faixasTexto
) {}
